...
const BLOG = {
  ...
  WIDGET_PET_LINK:
    ...
    'https://cdn.jsdelivr.net/npm/kanbanniang@0.2.12/model/HyperdimensionNeptunia/vert_swimwear/index.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
